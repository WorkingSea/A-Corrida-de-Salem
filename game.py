...
def rebelião():
    ...
    def linchamento(chance):
        if chance >= 50:
            ...
            if Escolha == '1':
                console.print(Personagem.Nome + ' foge do palácio junto com a família real através de um túnel secreto, o Rei se refugia junto com a corte em uma cidade próxima e o palácio é tomado pela nobreza, que coroa Conde Henrique como o novo Rei de Salém, o Reino se divide entre os dois candidatos, assim como as ordens de cavalaria, tanto a capital quanto o reino entram em sangrentos conflitos.')
                Vencedor = dado(2)
                if Vencedor == 1:
